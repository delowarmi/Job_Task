  ...
  return (
      <div className=' relative'>
        ...
        {/* <OutsideClickHandler onOutsideClick ={() => { setHidden(false); }} > */}
                ...
                <Heading as={'h4'} text={" Sing In "} className = ' text-white text-[14px] border border-b-gray-300 rounded-md translate-y-[-50%] ml-2 mt-3 pl-2 pr-2 cursor-pointer' onClick={() => setHidden(!hidden)} />
                </div>
                {hidden && (
